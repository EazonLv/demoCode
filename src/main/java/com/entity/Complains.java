...
public class Complains {
	...
	public String getComplainsid() { return complainsid; }
	public void setComplainsid(String complainsid) { this.complainsid = complainsid; }
...
return "Complains [complainsid="+this.complainsid+", usersid="+this.usersid+", title="+this.title+", contents="+this.contents+", addtime="+this.addtime+", status="+this.status+", reps="+this.reps+", username="+this.username+"]";
}
