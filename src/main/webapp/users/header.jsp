				...
				<tr>
					...
					<td align="left">
						<table width="100" border="0" cellpadding="0" cellspacing="0" background="themes/nzblue/images/nzcms/nzcms.07.gif">
							<tr>
								<td height="38" align="center">
									<a href="index/school.action" class="left" onmouseover="mopen('21')"
												onMouseOut="mclosetime()">留学院校</a>
								</td>
							</tr>
						</table>
									...
									<tr>
										<td align=left>
											<table width="100" height="35" border="0" cellpadding="0">
												<tr>
													<td align="left">
														<a href="index/city.action?id=${city.cityid }"><font class="p14"><img src="themes/nzblue/images/biao.gif"
																alt="图标" border="0">&nbsp;${city.cityname }</font> </a>
													</td>
												</tr>
											</table>
										</td>
					...
					<td align="left">
						<table width="100" border="0" cellpadding="0" cellspacing="0" background="themes/nzblue/images/nzcms/nzcms.07.gif">
							<tr>
								<td height="38" align="center">
									<a href="index/files.action" class="left">报名文件下载</a>
								</td>
							</tr>
						</table>
					</td>
					<td align="left">
						<table width="100" border="0" cellpadding="0" cellspacing="0" background="themes/nzblue/images/nzcms/nzcms.07.gif">
							<tr>
								<td height="38" align="center">
									<a href="index/bbs.action" class="left">留言交流</a>
								</td>
							</tr>
						</table>
					</td>
										...
										<tr>
											<td align=left>
												<table width="100" height="35" border="0" cellpadding="0">
													<tr>
														<td align="left">
															<a href="index/preAsign.action"><font class="p14"><img src="themes/nzblue/images/biao.gif"
																	alt="图标" border="0">&nbsp;网上报名</font> </a>
														</td>
													</tr>
												</table>
											</td>
										...
										<tr>
											<td align=left>
												<table width="100" height="35" border="0" cellpadding="0">
													<tr>
														<td align="left">
															<a href="index/myAsign.action"><font class="p14"><img src="themes/nzblue/images/biao.gif"
																	alt="图标" border="0">&nbsp;我的报名</font> </a>
														</td>
													</tr>
												</table>
											</td>
