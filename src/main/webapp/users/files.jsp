			...
			<td align="center">
				...
				<table width="98%" border="0" cellpadding="0" cellspacing="0" bgcolor="#F5F5F5" class="bg_qc">
					<tr>
						...
						<td align="left" class="p12">您的位置： <a href="<%=basePath%>">首页</a>
						</td>
					</tr>
				</table>
				...
				<table width="98%" border="0" cellpadding="0" cellspacing="0"
					...
					<tr>
						<td width="190" height="33" align="center" class="title14b">报名文件下载</td>
						<td align="right">&nbsp;&nbsp;</td>
						<td>&nbsp;</td>
					</tr>
				</table>
				...
				<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" class="dx">
					<c:forEach items="${filesList}" var="files">
						<tr>
							...
							<td align="left" class="p14">${files.filesname }</td>
							<td width="180" align="left">发布日期：${files.addtime }</td>
							<td width="140" align="left"><a href="${files.fileurl }"><font color="red">点击下载</font></a></td>
						</tr>
					</c:forEach>
				</table> <!--文章显示 -->
				<table height="20" border="0" cellpadding="0" cellspacing="0">
