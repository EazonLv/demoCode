		...
		<tr>
			<td align="center" valign="top">
				<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#F5F5F5" class="bg_qc">
					<tr>
						<td width="25" height="20" align="center"><img src="themes/nzblue/images/nzcms.xinxin.gif" alt="标" width="9" height="9" /></td>
						<td align="left" class="p12">您的位置： <a href="index/index.action">首页</a>&nbsp;&gt;&nbsp;&nbsp;个人信息
						</td>
					</tr>
				</table>
					...
					<table width="56%" border="0" cellpadding="5" cellspacing="1" bgcolor="#E0EDB7">
						...
						<tr>
							...
							<td bgcolor="#FFFFFF">${sessionScope.users.username }<input type="hidden" name="username" id="username"
								...
								<input type="hidden" name="regdate" id="regdate" value="${sessionScope.users.regdate }" />
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td bgcolor="#FFFFFF"><input type="text" style="width: 260px; height: 30px" name="image" id="image" onclick="selimage();"
								value="${sessionScope.users.image }" readonly="readonly" /></td>
						</tr>
						<tr>
