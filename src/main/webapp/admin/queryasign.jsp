...
<body>
	<nav class="breadcrumb">
		<i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span>学生报名管理 <span class="c-gray en">&gt;</span>
		学生报名查询 <a class="btn btn-success radius r" style="line-height: 1.6em; margin-top: 3px"
	...
	<div class="page-container">
		<table class="table table-border table-bordered table-bg">
			<thead>
				<tr>
					<th scope="col" colspan="10">学生报名查询</th>
				</tr>
				<tr class="text-c">
					<th class="center">报名单号</th>
					<th class="center">学生</th>
					<th class="center">学校</th>
					<th class="center">学位</th>
			...
			<c:forEach items="${asignList}" var="asign">
				<tr class="text-c">
					...
					<td class="center">${asign.schoolname}</td>
					<td class="center">${asign.degreename}</td>
					<td class="center">${asign.price}</td>
					<td class="center">${asign.addtime}</td>
		...
		<div class="text-c">
			<form action="asign/queryAsignByCond.action" name="myform" method="post">
				查询条件： <span class="select-box" style="width: 200px;"><select name="cond" class="select">
						<option value="ano">按报名单号查询</option>
						<option value="usersid">按学生查询</option>
						<option value="schoolid">按学校查询</option>
						<option value="degreeid">按学位查询</option>
						<option value="fileurl">按报名文件查询</option>
						<option value="price">按费用查询</option>
