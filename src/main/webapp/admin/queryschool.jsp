...
<body>
	<nav class="breadcrumb">
		...
		学校查询 <a class="btn btn-success radius r" style="line-height: 1.6em; margin-top: 3px"
	...
	<div class="page-container">
		<table class="table table-border table-bordered table-bg">
			<thead>
				<tr>
					<th scope="col" colspan="8">学校查询</th>
				</tr>
				<tr class="text-c">
			...
			<c:forEach items="${schoolList}" var="school">
				<tr class="text-c">
					<td class="center">${school.schoolname}</td>
					<td class="center">${school.cityname}</td>
					<td class="center">${school.addtime}</td>
					<td class="center">${school.hits}</td>
					<td class="center">${school.asignnum}</td>
				</tr>
			</c:forEach>
		</table>
		<div class="cl pd-5 mt-20"></div>
		<div class="text-c">
			<form action="school/querySchoolByCond.action" name="myform" method="post">
				查询条件： <span class="select-box" style="width: 200px;"><select name="cond" class="select">
						<option value="schoolname">按学校名称查询</option>
						<option value="cityid">按所在地区查询</option>
						...
						<option value="contents">按学校介绍查询</option>
