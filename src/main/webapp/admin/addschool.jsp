...
<body>
	<nav class="breadcrumb">
		...
		新增学校 <a class="btn btn-success radius r" style="line-height: 1.6em; margin-top: 3px" href="school/createSchool.action"
			title="刷新"><i class="Hui-iconfont">&#xe68f;</i></a>
	</nav>
	<article class="page-container">
		<form class="form form-horizontal" id="form-article-add" action="school/addSchool.action" name="myform" method="post">
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2">学校名称</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" name="schoolname" class="input-text" id="schoolname" placeholder="请输入学校名称" />
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2">所在地区</label>
				<div class="formControls col-xs-8 col-sm-9">
					<span class="select-box"><select name="cityid" class="select" id="cityid"><option value="">---请选择所在地区--</option>
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					...
					<textarea class="textarea" name="contents" id="contents" placeholder="请输入学校介绍"> </textarea>
